...
public class UpdateFolderAsyncTask extends AsyncTask<String, String, JSONObject> {
    ...
    public UpdateFolderAsyncTask(Activity activity, DocumentChildResponseDTO documentUpdate) {
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        ...
        try {
            ...
            documentUpdate.setName(folderResponseDTO.getName());
