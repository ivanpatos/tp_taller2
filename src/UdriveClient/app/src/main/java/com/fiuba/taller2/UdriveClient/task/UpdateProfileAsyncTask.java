...
public class UpdateProfileAsyncTask extends AsyncTask<String, String, JSONObject> {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try{
            URL url = new URL(serverUrl + userUrl + "/" + username);
    ...
    protected void onPreExecute() {
        ...
        dialog.setMessage(activity.getString(R.string.update_profile_waiting));
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        ...
        Toast.makeText(activity, activity.getString(R.string.update_profile_success), Toast.LENGTH_SHORT).show();
    }
}
